...
class ServicioAdapter(private val servicios: List<ServicioResponse>, private val context: Context, private val itemClickListener: FamiliarHomeFragment): RecyclerView.Adapter<ServicioAdapter.ViewHolder>(){
